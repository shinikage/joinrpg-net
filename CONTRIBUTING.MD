...
- If possible, avoid the usage of C# extensions 
- It is kindly advised to write commit messages, tasks, comments to PRs and all other essential information on English.
